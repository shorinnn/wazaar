	...
	<section class="container-fluid header">
        ...
        <div class="row">
        	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            	...
            	<a href="#" class="header-tabs regular-paragraph active">{{ trans('courses/general.curriculum') }}</a>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            	<div class="right steps-remaining">
                	<p class="regular-paragraph no-margin">
                    	{{ trans('courses/general.complete') }} <span>1 {{ trans('courses/general.steps') }}</span> {{ trans('courses/general.to_submit_course') }}
                    </p>
                </div>
            </div>
        </div>
