                    ...
                    <div class="stat-block">
                        <div class="dropdown-wrapper">
                            <button class="btn btn-default" type="button">
                                {{trans('analytics.today')}}{{trans('instructors/analytics.sales-revenue')}} <span id="header-sales-frequency"></span></button>
                    ...
                    <div id="sales-today" class="stat-block">
                        <div class="dropdown-wrapper">
                            <button aria-expanded="false" data-toggle="dropdown" class="btn btn-default dropdown-toggle" id="btnGroupDrop3" type="button">
                                {{trans('analytics.today')}}{{trans('instructors/analytics.unit-sales')}} <span id="header-sales-count-frequency"></span></button>
