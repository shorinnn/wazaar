...
<p class="email_already_registered">{{trans('acl.fb_email_already_registered')}}</p>
...
<form class="social-link-form" role="form" method="POST" action="{{{ action('UsersController@doLinkFacebook') }}}" accept-charset="UTF-8">
