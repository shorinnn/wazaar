	...
	<div class="container-fluid classroom-view">
        ...
        <div class="slide-menu">
        	<div class="header">
                ...
                <h2 class="clear">The Ultimate Guide to Digital Marketing</h2>
                <div class="progress-box">
                    ...
                    <span class="progress-count">41%</span>
                </div>
            </div>
            <div class="course-topics-box">
            	<div class="topic-header clearfix">
                	<h3 class="left"><em>1. </em> INTRODUCTION</h3>
                    <span class="right">1/5</span>               
                </div>
                <div class="topics">
                	<ul>
                    	<li class="completed">
                        	<a href="#">The 3 Second Rule <span><em></em><i class="wa-check"></i></span></a>
                        </li>
                    	<li>
                        	<a href="#">Welcome to Marketing in a Digital World<span><em></em><i class="wa-check"></i></span></a>
                        </li>
                    	<li>
                        	<a href="#">The 3 Second Rule <span><em></em><i class="wa-check"></i></span></a>
                        </li>
            ...
            <div class="course-topics-box">
            	<div class="topic-header clearfix">
                	<h3 class="left"><em>2. </em> Website Management</h3>
        	...
        	<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
            	<div class="questions-sidebar">
                    ...
                    <div class="tab-contents clear">
                        ...
                        <div class="rows questions-box active">
                        	<span class="question-title">What are the most influential UX design blogs?</span>
                            <span class="replies-count">2 Replies  </span>
                        </div>
                        <div class="rows questions-box">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 no-padding">
            	<div class="discussion-sidebar">
                    	...
                    	<div class="row">
                            ...
                            <div class="col-xs-11 col-sm-11 col-md-11 col-lg-11">
                                <form>
                                    ...
                                    <div>
                                        <textarea placeholder="Describe more details on your subject">
                    ...
                    <div class="clearfix ask-question-fields-footer">
                        <div class="buttons">
                            <a href="#" class="large-button default-button cancel">Cancel</a>
                            <a href="#" class="large-button blue-button submit-question">Submit question</a>
                        </div>
                    </div>
                </div>
            </div>
