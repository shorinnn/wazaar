    	...
    	<div class="container">
        	<div class="row">
            	...
            	<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                	<p>54% completed</p>
                    <div class="progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 54%;">
                            <span></span>
                        </div>
                    </div>
                    <a href="#" class="resume-course large-button blue-button"><i class="wa-play"></i>Resume course</a>
                </div>
            </div>
        </div>
    </div>
