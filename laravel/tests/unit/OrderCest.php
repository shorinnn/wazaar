...
class OrderCest{
    ...
    private function setupDatabase() {
        ...
        Config::set('earnings.instructor_percentage', 70);
        Config::set('earnings.site_percentage', 30);
        Config::set('earnings.ltc_percentage', 5);
        Config::set('earnings.agency_percentage', 2);
    }
...
//        
//        $I->assertEquals( $purchase->purchase_price, 100 );
//        $I->assertEquals( $purchase->original_price, 100 );
...
//        $I->assertEquals( $purchase->balance_transaction_id, 111 );
...
//        $purchase = Purchase::orderBy('id','desc')->first();
//        
//        $I->assertEquals( $purchase->purchase_price, 99 );
//        $I->assertEquals( $purchase->original_price, 100 );
...
//        $I->assertEquals( $purchase->balance_used, 10 );
//        $I->assertEquals( $purchase->balance_transaction_id, 111 );
//        $I->assertEquals( $purchase->instructor_earnings, 99 * 0.7 );
//        $I->assertEquals( $purchase->affiliate_earnings, 0 );
//        $nonInstructorMoney = 99 * .3;
