...
class ProductAffiliateTransactionsCest{
    ...
    public function credit(UnitTester $I){
        $affiliate = ProductAffiliate::find(4);
        $I->assertEquals( 0, $affiliate->affiliate_balance );
        $course = Course::first();
        $I->assertGreaterThan(0, $affiliate->credit( 100, $course, 1, 1 ) );
    ...
    public function failCreditBadAmount(UnitTester $I){
        $affiliate = ProductAffiliate::find(4);
        $I->assertEquals( 0, $affiliate->affiliate_balance );
        $I->assertFalse( $affiliate->credit( 'ad', Course::first(), 1, 1 ) );
