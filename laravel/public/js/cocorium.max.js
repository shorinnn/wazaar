    ...
    isAngry:function(){
        ...
        images[0] = image = new Image();
            function startAngry() {
                ...
                if (++loaded === 1) {
                    $('#max-angry-container').remove();
                    $('head').append('<link rel="Stylesheet" type="text/css" href="'+COCORIUM_APP_PATH+'css/max.css" />');
                    $('body').html('<div id="max-angry-container"></div>');
                    container = document.getElementById('max-angry-container');
