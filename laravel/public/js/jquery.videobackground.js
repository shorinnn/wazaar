...
(function ($, document, window) {
	...
	function loadedEvents(that) {
		...
		that.controls.find('.ui-video-background-play a').on('click', function (event) {
			...
			var playerWidth = player[0].videoWidth;
			TweenMax.to('#bckgrd-video-overlay', 1, {
			...
			$('#bckgrd-video-overlay').addClass('pull-up-controls');
			TweenMax.to('#video-background', 1, {height: playerHeight});
			TweenMax.to('#video-background video, #bckgrd-video-container', 1, {
				height: playerHeight, 
				width: playerWidth, 
				minHeight: 'auto', 
				minWidth: 'auto',
